  ...
  return <AppShell>
    ...
    <main className="gatewayHome">
      ...
      <section className="gatewayIntro wrap" data-reveal>
        <div>
          <p className="eyebrow">CHOOSE HOW YOU WANT TO DESIGN</p>
          <h2>Two ways into the atelier.</h2>
        </div>
      ...
      <section className="gatewayChoices wrap" data-reveal>
        <Link href="/designer-brief" className="gatewayCard gatewayDesigner">
          ...
          <div className="gatewayCardCopy">
            <p className="eyebrow">GUIDED DESIGN</p>
            <h3>Find the right outfit for the moment.</h3>
        ...
        <Link href="/visual" className="gatewayCard gatewayVisual">
          ...
          <div className="gatewayCardCopy">
            <p className="eyebrow">VISUAL CLARITY</p>
            <h3>See the garment before you decide.</h3>
      ...
      <section className="gatewayFoot wrap" data-reveal>
        <span>LLINEN EARTH / DIGITAL ATELIER</span>
        <p>Designer for judgement. Live Visual for clarity. Atelier for execution.</p>
      </section>
    </main>
  </AppShell>;
}
