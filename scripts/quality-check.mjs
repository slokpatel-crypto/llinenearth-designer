...
const securityContracts = [
  ...
  ["src/app/api/operator/sync/route.ts", ["timingSafeEqual","supabaseAdminHeaders","received_at.asc,id.asc","cleanOperatorPayload","schemaVersion","measurements_updated"]],
  ...
  ["supabase/migrations/20260920_style_events_hardening.sql", ["llinen_cloud_health","select 3;","revoke all on table public.style_events from anon","grant select, insert on table public.style_events to service_role"]],
];
